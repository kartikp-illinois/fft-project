...
HD_PWD='C:/Users/karti/Documents/ECE_385/FFT_Project/FFT_Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fft_accelerator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fft_accelerator.tcl
